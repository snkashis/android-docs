...
var PageHelmet = (function(_React$Component) {
  ...
  function PageHelmet() {
    ...
    return possibleConstructorReturn(
      this,
      (PageHelmet.__proto__ || Object.getPrototypeOf(PageHelmet)).apply(
        this,
        arguments
      )
    );
...
var shellStyles = {
  ...
  popupMenuBody:
    'shell-shadow-darken10-bold shell-bg-white shell-absolute shell-inline-block shell-round shell-txt-s',
  popupMenuNavHeading:
    'shell-txt-uppercase shell-txt-s shell-txt-spacing1 shell-txt-fancy shell-color-light-blue',
  popupMenuLink:
    'shell-txt-bold shell-color-blue-on-hover shell-color-gray-dark',
  popupTriangle:
...
var UserMenu = (function(_React$Component) {
  ...
  function UserMenu() {
    ...
    return possibleConstructorReturn(
      this,
      (UserMenu.__proto__ || Object.getPrototypeOf(UserMenu)).apply(
        this,
        arguments
      )
    );
          ...
          React__default.createElement(
                  ...
                  React__default.createElement(
                    ...
                    React__default.createElement(
                      'svg',
                      {
                        viewBox: '0 0 18 18',
                        className:
                          'shell-icon shell-absolute shell-mt-neg12 shell-h24 shell-w24',
                        style: { left: '100%', top: '50%' }
                      },
                      React__default.createElement('path', {
                        d: 'M12,7L6,7l3,4L12,7z'
                      })
                    ),
            ...
            React__default.createElement(
              'div',
              {
                ...
                className:
                  shellStyles.popupMenuContainer +
              ...
              React__default.createElement('div', {
                ...
                className:
                  shellStyles.popupTriangle + ' shell-animated-menu__pointer',
                style: {
                  position: 'absolute',
                  top: 0
                }
              ...
              React__default.createElement(
                ...
                {
                  className:
                    'shell-shadow-darken10-bold shell-bg-white shell-absolute shell-py30 shell-px24 shell-round shell-w-full shell-w210-mm',
                  id: 'user-menu-body',
                  style: {
                    right: 10
                  }
                ...
                React__default.createElement(
                  ...
                  React__default.createElement(
                    'a',
                    {
                      ...
                      href: '/admin/',
                      className:
                        'shell-color-gray-dark shell-color-blue-on-hover shell-txt-s shell-txt-bold shell-my12',
                      style: { display: 'none' }
                    },
                    'Admin'
                  ),
                ...
                React__default.createElement(
                  ...
                  {
                    className: 'shell-mt-neg12',
                    'data-app-specific-user-menu': true
                  },
                  React__default.createElement(
                    'a',
                    {
                ...
                React__default.createElement(
                  ...
                  {
                    className:
                      'shell-pt24 shell-mt24 shell-border-t shell-border--gray-light'
                  },
                  React__default.createElement('div', {
                    'data-user-name': true,
                    className: 'shell-txt-s shell-color-gray'
                  }),
                  React__default.createElement(
                    'button',
                    {
                      ...
                      className:
                        'shell-color-gray-dark shell-color-blue-on-hover shell-txt-s shell-txt-bold shell-mt6 shell-block shell-w-full'
                    },
                    React__default.createElement(
                      'div',
                      {
                      ...
                      React__default.createElement(
                        'svg',
                        {
                          className: 'shell-icon shell-mr3',
                          viewBox: '0 0 18 18'
                        },
                        React__default.createElement('path', {
                          d:
...
var PopupMenu = (function(_React$Component) {
  ...
  function PopupMenu() {
    ...
    return possibleConstructorReturn(
      this,
      (PopupMenu.__proto__ || Object.getPrototypeOf(PopupMenu)).apply(
        this,
        arguments
      )
    );
...
var SmallMapsIcon = (function(_React$Component) {
  ...
  function SmallMapsIcon() {
    ...
    return possibleConstructorReturn(
      this,
      (SmallMapsIcon.__proto__ || Object.getPrototypeOf(SmallMapsIcon)).apply(
        this,
        arguments
      )
    );
    ...
    },
    {
      ...
      value: function render() {
        return React__default.createElement(
          ...
          React__default.createElement('path', {
            d:
              'M4 10.5V0l4 1.5V12l-4-1.5zM3 0L.6.8c-.4.1-.6.5-.6.9v9c0 .4.5.6.9.5l2.1-.7V0zm8.4 11.2c.4-.1.6-.5.6-.9v-9c0-.4-.4-.7-.9-.5L9 1.5V12l2.4-.8z',
            fill: '#4264FB',
            fillRule: 'nonzero'
          })
        );
...
var SmallNavigationIcon = (function(_React$Component) {
  ...
  function SmallNavigationIcon() {
    ...
    return possibleConstructorReturn(
      this,
      (
        SmallNavigationIcon.__proto__ ||
        Object.getPrototypeOf(SmallNavigationIcon)
      ).apply(this, arguments)
    );
  }
    ...
    },
    {
      ...
      value: function render() {
        return React__default.createElement(
          ...
          React__default.createElement('path', {
            d:
              'M2.5 11.2c-.9.8-1.9 0-1.5-1l4-9c.2-.4.6-.8 1-.8s.8.4 1 .8l4 9c.4 1-.6 1.8-1.5 1L6 8.2l-3.5 3z',
            fill: '#4264FB',
            fillRule: 'nonzero'
          })
        );
...
var SmallStudioIcon = (function(_React$Component) {
  ...
  function SmallStudioIcon() {
    ...
    return possibleConstructorReturn(
      this,
      (
        SmallStudioIcon.__proto__ || Object.getPrototypeOf(SmallStudioIcon)
      ).apply(this, arguments)
    );
  }
...
var SmallServicesIcon = (function(_React$Component) {
  ...
  function SmallServicesIcon() {
    ...
    return possibleConstructorReturn(
      this,
      (
        SmallServicesIcon.__proto__ || Object.getPrototypeOf(SmallServicesIcon)
      ).apply(this, arguments)
    );
  }
    ...
    },
    {
      ...
      value: function render() {
        return React__default.createElement(
          ...
          React__default.createElement('path', {
            d:
              'M4.4.4l-1.8 1 .5 2.4c-.3.5-.6.9-.8 1.4L0 6v2l2.3.8c.2.5.5.9.8 1.3l-.5 2.4 1.8 1 1.8-1.6c.3.1.5.1.8.1.3 0 .5 0 .8-.1l1.8 1.6 1.8-1-.5-2.4c.3-.4.6-.8.8-1.3L14 8V6l-2.3-.8c-.2-.5-.5-.9-.8-1.3l.5-2.4-1.8-1-1.8 1.6C7.5 2 7.3 2 7 2c-.3 0-.5 0-.8.1L4.4.4zM7 5c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2z',
            fill: '#4264FB',
            fillRule: 'nonzero'
          })
        );
...
var CompanyMenu = (function(_React$Component) {
  ...
  function CompanyMenu() {
    ...
    return possibleConstructorReturn(
      this,
      (CompanyMenu.__proto__ || Object.getPrototypeOf(CompanyMenu)).apply(
        this,
        arguments
      )
    );
    ...
    },
    {
      ...
      value: function render() {
        ...
        return React__default.createElement(
          ...
          {
            className:
              'shell-color-blue shell-txt-bold shell-color-gray-dark-on-hover'
          },
          textWithoutLastWord,
          ' ',
          React__default.createElement(
...
var DocumentationMenu = (function(_React$Component) {
  ...
  function DocumentationMenu() {
    ...
    return possibleConstructorReturn(
      this,
      (
        DocumentationMenu.__proto__ || Object.getPrototypeOf(DocumentationMenu)
      ).apply(this, arguments)
    );
  }
  ...
  createClass(DocumentationMenu, [
          ...
          React__default.createElement(
            ...
            linkItem.subTitle &&
              React__default.createElement(
                ...
                {
                  className:
                    'shell-txt-xs shell-txt-normal shell-color-light-blue'
                },
                linkItem.subTitle
              )
          )
    ...
    },
    {
      ...
      value: function renderSectionNav(section) {
        ...
        var subKeys = section.subsections
        ...
        return React__default.createElement(
          ...
          React__default.createElement(
            ...
            {
              className:
                'shell-border-b shell-border--gray-light shell-pb6 shell-mb12'
            },
            React__default.createElement(section.icon, {
              className: 'shell-align-middle shell-mb3'
            }),
            React__default.createElement(
              'span',
          ...
          subKeys &&
            React__default.createElement(
              ...
              subKeys.map(function(subKey) {
                return _this2.renderSubsectionNav(
                  subKey,
                  section.subsections[subKey]
                );
              })
            )
        );
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              ...
              React__default.createElement(
                ...
                {
                  className:
                    'shell-col shell-col--4 shell-bg-gray-faint shell-round shell-pt30 shell-px30'
                },
                React__default.createElement(
                  'div',
                  {
              ...
              React__default.createElement(
                ...
                React__default.createElement(
                  ...
                  React__default.createElement(NavigationHighlightLink, {
                    label: docNavSection.more.title
                  })
                )
              ),
              React__default.createElement(
                ...
                {
                  className:
                    'shell-col shell-col--4 shell-bg-gray-faint shell-round shell-px30 shell-pb30'
                },
                React__default.createElement(
                  'a',
                  {
                  ...
                  React__default.createElement(NavigationHighlightLink, {
                    label: helpNavSection.more.title
                  })
                )
              )
            )
...
var ProductsNavItem = (function(_React$Component) {
  ...
  function ProductsNavItem() {
    ...
    return possibleConstructorReturn(
      this,
      (
        ProductsNavItem.__proto__ || Object.getPrototypeOf(ProductsNavItem)
      ).apply(this, arguments)
    );
  }
      ...
      value: function render() {
        ...
        return React__default.createElement(
          'a',
          {
            href: link.to,
            className:
              'shell-products-nav-item shell-icon--' +
              lowerName +
              ' shell-block shell-mr6 shell-color-blue-on-hover',
            'data-nav-link': true,
...
var PlatformsNavItem = (function(_React$Component) {
  ...
  function PlatformsNavItem() {
    ...
    return possibleConstructorReturn(
      this,
      (
        PlatformsNavItem.__proto__ || Object.getPrototypeOf(PlatformsNavItem)
      ).apply(this, arguments)
    );
  }
      ...
      value: function render() {
        ...
        return React__default.createElement(
          'a',
          {
            ...
            'data-test': 'nav-link-' + link.name,
            className:
              'shell-platforms-nav-item shell-h30 shell-py6 shell-icon--' +
              lowerName +
              ' shell-block shell-color-blue-on-hover shell-txt-bold'
          },
          link.name
        );
      }
...
var ProductsMenu = (function(_React$Component) {
  ...
  function ProductsMenu() {
    ...
    return possibleConstructorReturn(
      this,
      (ProductsMenu.__proto__ || Object.getPrototypeOf(ProductsMenu)).apply(
        this,
        arguments
      )
    );
          ...
          React__default.createElement(
              ...
              React__default.createElement(
                ...
                productsNavSection.links.map(function(link) {
                  return React__default.createElement(
                    ...
                    React__default.createElement(ProductsNavItem, {
                      link: link
                    })
                  );
                })
            ...
            React__default.createElement(
              ...
              React__default.createElement(
                ...
                {
                  className:
                    'shell-flex-parent shell-flex-parent--space-between-main'
                },
                platformsNavSection.links.map(function(link) {
                  return React__default.createElement(
                    'div',
                    { key: link.name, className: 'shell-flex-child' },
                    React__default.createElement(PlatformsNavItem, {
                      link: link
                    })
                  );
                })
...
var SolutionsMenu = (function(_React$Component) {
  ...
  function SolutionsMenu() {
    ...
    return possibleConstructorReturn(
      this,
      (SolutionsMenu.__proto__ || Object.getPrototypeOf(SolutionsMenu)).apply(
        this,
        arguments
      )
    );
...
var NavigationItem = (function(_React$Component) {
  ...
  function NavigationItem() {
    ...
    return possibleConstructorReturn(
      this,
      (NavigationItem.__proto__ || Object.getPrototypeOf(NavigationItem)).apply(
        this,
        arguments
      )
    );
    ...
    },
    {
      ...
      value: function render() {
        ...
        var showNavHeading = this.props.name
          ...
          : '';
        return React__default.createElement('div', null, showNavHeading, items);
      }
    }
  ]);
  ...
  createClass(NavigationLinkList, [
    ...
    },
    {
      ...
      value: function render() {
        ...
        // Font size is larger for items with a heading in mobile
        var linkFontSize =
          this.props.title && this.props.navigationType === 'mobile-navigation'
            ? 'shell-txt-l'
            : 'shell-txt-m';

        // Special case: the custom combination menu doesn't need a heading
        var navigationHeading = this.props.title
          ? React__default.createElement(
              'div',
              { className: shellStyles.popupMenuNavHeading },
              this.props.title
...
var MobileUserMenu = (function(_React$Component) {
  ...
  function MobileUserMenu() {
    ...
    return possibleConstructorReturn(
      this,
      (MobileUserMenu.__proto__ || Object.getPrototypeOf(MobileUserMenu)).apply(
        this,
        arguments
      )
    );
      ...
      value: function render() {
        return React__default.createElement(
          ...
          React__default.createElement(
            ...
            {
              className:
                'shell-border-t shell-border--gray-light shell-mb30 shell-pt30',
                ...
                React__default.createElement(
                  ...
                  React__default.createElement(
                    'a',
                    {
                      href: '/account/',
                      className:
                        shellStyles.popoverNavLink + ' shell-txt-m shell-mb0'
                    },
                    'Account'
                  )
                ),
          ...
          React__default.createElement(
            ...
            {
              className:
                'shell-bg-gray-faint shell-py24 shell-px24 shell-ml-neg24 shell-mr-neg24 shell-mb-neg24'
            },
            React__default.createElement(
              'div',
              ...
              React__default.createElement(
                ...
                {
                  className:
                    'shell-flex-parent shell-flex-parent--space-center-main shell-flex-parent--space-between-main'
                },
                React__default.createElement('div', {
                  'data-user-name': true,
                ...
                React__default.createElement(
                  ...
                  React__default.createElement(
                    'button',
                    {
                      ...
                      className:
                        shellStyles.popoverNavLink + ' shell-txt-s shell-mb0'
                    },
                    React__default.createElement(
                      'div',
                      {
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              ...
              React__default.createElement(
                'div',
                {
                  className: 'shell-flex-parent--column',
                  'data-generic-navigation': true
                },
                React__default.createElement(
                  'div',
                  ...
                  React__default.createElement(
                    ...
                    React__default.createElement(
                      ...
                      _extends(
                        {},
                        navigationMenuData.headerMainMenus.products.products,
                        {
                    ...
                    React__default.createElement(
                      ...
                      _extends(
                        {},
                        navigationMenuData.headerMainMenus.products.platforms,
                        {
                          navigationType: 'mobile-navigation'
                        }
                      )
                  ...
                  React__default.createElement(
                    ...
                    React__default.createElement(
                      ...
                      _extends(
                        {},
                        navigationMenuData.headerMainMenus.solutions.industries,
                        {
                          navigationType: 'mobile-navigation'
                        }
                      )
              ...
              React__default.createElement(
                ...
                React__default.createElement(
                  'a',
                  {
                    ...
                    href: '/admin/',
                    className:
                      'shell-color-gray-dark shell-color-blue-on-hover txt-l shell-mb12',
                    style: { display: 'none' }
                  },
                  'Admin'
                ),
...
var PageHeader = (function(_React$Component) {
  ...
  function PageHeader() {
    ...
    return possibleConstructorReturn(
      this,
      (PageHeader.__proto__ || Object.getPrototypeOf(PageHeader)).apply(
        this,
        arguments
      )
    );
      ...
      value: function render() {
        ...
        return React__default.createElement(
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              ...
              React__default.createElement(
                ...
                React__default.createElement(ProductsMenu, {
                  darkText: this.props.darkText
                }),
                React__default.createElement(SolutionsMenu, {
                  darkText: this.props.darkText
                }),
                React__default.createElement(DocumentationMenu, {
                  darkText: this.props.darkText
                }),
                React__default.createElement(CompanyMenu, {
                  darkText: this.props.darkText
                }),
                React__default.createElement(
                  NavigationItem,
            ...
            React__default.createElement(
              ...
              React__default.createElement(UserMenu, {
                darkText: this.props.darkText
              })
            )
          ),
          React__default.createElement(
            ...
            React__default.createElement(MobileMenuButton, {
              darkText: this.props.darkText
            })
          ),
...
var PageFooter = (function(_Component) {
  ...
  function PageFooter() {
    ...
    return possibleConstructorReturn(
      this,
      (PageFooter.__proto__ || Object.getPrototypeOf(PageFooter)).apply(
        this,
        arguments
      )
    );
    ...
    },
    {
      ...
      value: function renderLogo() {
        return React__default.createElement(
          ...
          {
            className:
              'shell-footer-column shell-col shell-col--6 shell-flex-child shell-mt24 shell-mt0-mm shell-none shell-block-ml'
          },
          React__default.createElement('a', {
          ...
          return React__default.createElement(
            ...
            React__default.createElement(
              'a',
              {
                href: link.to,
                className:
                  'shell-txt-s shell-color-gray-dark shell-color-blue-on-hover'
              },
              link.name
            )
          );
    ...
    },
    {
      ...
      value: function renderMenuHighlightedLinkList(menuData) {
        if (
          ...
          menuData.highlightedLinks.length === 0
        )
          return null;
          ...
          if (!firstVisibleHighlightedLink) {
            ...
            return React__default.createElement(
              ...
              React__default.createElement(
                ...
                {
                  className:
                    'shell-inline shell-pt12 shell-border-t shell-border--gray-light'
                },
                React__default.createElement(
                  'a',
                  {
    ...
    },
    {
      ...
      value: function renderMenus() {
        ...
        return footerColumnItemsIds.map(function(columnId, index) {
          var columnClasses =
            'shell-footer-column shell-col shell-col--6 shell-flex-child shell-mt24 shell-mt0-mm';
          if (index === footerColumnItemsIds.length - 1)
    ...
    },
    {
      ...
      value: function renderLegalAndSocialMedia() {
        return React__default.createElement(
          ...
          React__default.createElement(FooterLegalStrip, {
            className: 'shell-col shell-col--12 shell-col--6-mm shell-my12'
          }),
          React__default.createElement(FooterSocialMediaStrip, {
            className:
          ...
          React__default.createElement(
            ...
            React__default.createElement(
              'div',
              {
                id: 'page-footer-nav',
                className:
                  'shell-grid shell-mt24 shell-flex-parent-mm shell-flex-parent--space-between-main-mm'
              },
              this.renderLogo(),
              this.renderMenus()
            ),
...
var DEFAULT_SOCIAL_IMAGE_URL =
  'https://www.mapbox.com/static/social-media/social-1200x630.png';
var DEFAULT_SOCIAL_IMAGE_THUMBNAIL_URL =
  'https://www.mapbox.com/static/social-media/social-120x120.png';
...
var MetaTagger = (function(_React$PureComponent) {
  ...
  function MetaTagger() {
    ...
    return possibleConstructorReturn(
      this,
      (MetaTagger.__proto__ || Object.getPrototypeOf(MetaTagger)).apply(
        this,
        arguments
      )
    );
  ...
  createClass(MetaTagger, [
    {
      ...
      value: function render() {
        ...
        return React__default.createElement(Helmet__default, {
          title: suffixedTitle,
          meta: metaItems
        });
      }
...
var ReactPageShell = (function(_React$Component) {
  ...
  function ReactPageShell() {
    ...
    return possibleConstructorReturn(
      this,
      (ReactPageShell.__proto__ || Object.getPrototypeOf(ReactPageShell)).apply(
        this,
        arguments
      )
    );
    ...
    },
    {
      ...
      value: function render() {
        ...
        if (this.props.includeHeader) {
          header = React__default.createElement(PageHeader, {
