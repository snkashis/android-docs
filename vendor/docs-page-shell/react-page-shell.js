...
function PageHelmet() {
  return React.createElement(
    ...
    React.createElement('link', {
      ...
      sizes: '180x180',
      href:
        'https://static-assets.mapbox.com/branding/favicon/v1/apple-touch-icon.png?v=gAd4JjrGWl'
    }),
    React.createElement('link', {
      rel: 'icon',
      type: 'image/png',
      sizes: '32x32',
      href:
        'https://static-assets.mapbox.com/branding/favicon/v1/favicon-32x32.png?v=gAd4JjrGWl'
    }),
    React.createElement('link', {
      rel: 'icon',
      type: 'image/png',
      sizes: '16x16',
      href:
        'https://static-assets.mapbox.com/branding/favicon/v1/favicon-16x16.png?v=gAd4JjrGWl'
    }),
    React.createElement('link', {
      rel: 'manifest',
      href:
        'https://static-assets.mapbox.com/branding/favicon/v1/site.webmanifest?v=gAd4JjrGWl'
    }),
    React.createElement('link', {
      rel: 'mask-icon',
      href:
        'https://static-assets.mapbox.com/branding/favicon/v1/safari-pinned-tab.svg?v=gAd4JjrGWl',
      color: '#4264fb'
    }),
    React.createElement('link', {
      rel: 'shortcut icon',
      href:
        'https://static-assets.mapbox.com/branding/favicon/v1/favicon.ico?v=gAd4JjrGWl'
    }),
    React.createElement('meta', {
    ...
    React.createElement('meta', {
      ...
      content:
        'https://static-assets.mapbox.com/branding/favicon/v1/browserconfig.xml?v=gAd4JjrGWl'
    }),
    React.createElement('meta', {
      name: 'theme-color',
      content: '#ffffff'
  ...
  return React.createElement(
    ...
    React.createElement(
      'div',
      {
        ...
        className:
          'shell-absolute shell-z2 shell-disable-text-size-adjust shell-w-full shell-animated-menu',
        style: {
          right: 0,
          top: '100%',
          marginTop: '14px'
      ...
      React.createElement('div', {
        ...
        className:
          'shell-triangle-wide shell-triangle-wide--u shell-color-white shell-z5 shell-animated-menu__pointer',
        style: {
          position: 'absolute',
          top: 0
        }
...
var mobile = {
  maps: {
    links: nonMobile.maps.sdks.links
      .map(function(item) {
  ...
  navigation: {
    links: nonMobile.navigation.sdks.links
      .map(function(item) {
        return Object.assign({}, item, {
          name: 'SDK '.concat(item.name)
        });
...
function Logo(props) {
  ...
  nameClasses += darkText
    ? ' shell-color-blue shell-color-blue-dark-on-hover'
...
function PageHeader(props) {
  ...
  if (!props.darkText) {
    logoOverlay = React.createElement(
      'div',
      {
        className:
    ...
    React.createElement(
      ...
      React.createElement(
        'div',
        {
          ...
          className:
            'shell-grid shell-txt-s shell-color-darken50 shell-py12 shell-py0-ml'
        },
