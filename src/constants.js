/* SDK Versions */
export const JAVA_SDK_VERSION = '3.4.0';
export const MAP_SDK_VERSION = '6.3.0';
export const NAVIGATION_VERSION = '0.16.0';
...
export const LOCATION_LAYER_PLUGIN_VERSION = '0.7.1';
