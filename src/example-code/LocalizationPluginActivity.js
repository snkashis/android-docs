...
function MakeCodeSnippetJava() {
  const rawJavaCode = require('raw-loader!./java/localization-plugin-activity--full-java.java');
  return {
    raw: rawJavaCode,
...
const LocalizationPluginActivity = {
  java: MakeCodeSnippetJava(),
  kotlin: MakeCodeSnippetKotlin()
};

export { LocalizationPluginActivity };
