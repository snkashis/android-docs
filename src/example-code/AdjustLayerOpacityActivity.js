...
function MakeCodeSnippetJava() {
  const rawJavaCode = require('raw-loader!./java/adjust-layer-opacity-activity--full-java.java');
  return {
    raw: rawJavaCode,
...
const AdjustLayerOpacityActivity = {
  java: MakeCodeSnippetJava(),
  kotlin: MakeCodeSnippetKotlin()
};

export { AdjustLayerOpacityActivity };
