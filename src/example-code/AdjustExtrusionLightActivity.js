...
function MakeCodeSnippetJava() {
  const rawJavaCode = require('raw-loader!./java/adjust-extrusion-light-activity--full-java.java');
  return {
    raw: rawJavaCode,
...
const AdjustExtrusionLightActivity = {
  java: MakeCodeSnippetJava(),
  kotlin: MakeCodeSnippetKotlin()
};

export { AdjustExtrusionLightActivity };
