...
function MakeCodeSnippetJava() {
  const rawJavaCode = require('raw-loader!./java/zoom-dependent-fill-color-activity--full-java.java');
  return {
    raw: rawJavaCode,
...
const ZoomDependentFillColorActivity = {
  java: MakeCodeSnippetJava(),
  kotlin: MakeCodeSnippetKotlin()
};

export { ZoomDependentFillColorActivity };
