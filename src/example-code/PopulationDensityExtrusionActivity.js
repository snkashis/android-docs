...
function MakeCodeSnippetJava() {
  const rawJavaCode = require('raw-loader!./java/population-density-extrusion-activity--full-java.java');
  return {
    raw: rawJavaCode,
...
const PopulationDensityExtrusionActivity = {
  java: MakeCodeSnippetJava(),
  kotlin: MakeCodeSnippetKotlin()
};

export { PopulationDensityExtrusionActivity };
