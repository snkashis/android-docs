...
function MakeCodeSnippetJava() {
  const rawJavaCode = require('raw-loader!./java/marker-clusters-plugin-activity--full-java.java');
  return {
    raw: rawJavaCode,
...
const MarkerClustersPluginActivity = {
  java: MakeCodeSnippetJava(),
  kotlin: MakeCodeSnippetKotlin()
};

export { MarkerClustersPluginActivity };
