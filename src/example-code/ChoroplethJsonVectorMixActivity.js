...
function MakeCodeSnippetJava() {
  const rawJavaCode = require('raw-loader!./java/choropleth-json-vector-mix-activity--full-java.java');
  return {
    raw: rawJavaCode,
...
const ChoroplethJsonVectorMixActivity = {
  java: MakeCodeSnippetJava(),
  kotlin: MakeCodeSnippetKotlin()
};

export { ChoroplethJsonVectorMixActivity };
