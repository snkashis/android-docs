...
function MakeCodeSnippetJava() {
  const rawJavaCode = require('raw-loader!./java/multiple-geometries-activity--full-java.java');
  return {
    raw: rawJavaCode,
...
const MultipleGeometriesActivity = {
  java: MakeCodeSnippetJava(),
  kotlin: MakeCodeSnippetKotlin()
};

export { MultipleGeometriesActivity };
