    ...
    {includes(this.props.location.pathname, '/mapbox-services/') ? <PopoverTrigger content={
      <div className={'flex-parent wmin180 pb12 flex-parent--column'}>
        <strong className={'color-gray-light p6 txt-mm'}>Javadoc</strong>
          <a href={prefixLink('/api/mapbox-java/libjava-core/2.1.0/index.html')} className={`transition bright-blue-color-on-hover txt-bold color-gray-dark pl6 bg-transparent txt-ms`}>mapbox-java-core</a>
          <a href={prefixLink('/api/mapbox-java/libjava-geojson/2.1.0/index.html')} className={`transition bright-blue-color-on-hover txt-bold color-gray-dark pl6 bg-transparent txt-ms`}>mapbox-java-geojson</a>
          <a href={prefixLink('/api/mapbox-java/libjava-services/2.1.0/index.html')} className={`transition bright-blue-color-on-hover txt-bold color-gray-dark pl6 bg-transparent txt-ms`}>mapbox-java-services</a>
          <a href={prefixLink('/api/mapbox-java/libjava-services-rx/2.1.0/index.html')} className={`transition bright-blue-color-on-hover txt-bold color-gray-dark pl6 bg-transparent txt-ms`}>mapbox-java-services-rx</a>
          <a href={prefixLink('/api/mapbox-java/libandroid-services/2.1.0/index.html')} className={`transition bright-blue-color-on-hover txt-bold color-gray-dark pl6 bg-transparent txt-ms`}>mapbox-android-services</a>
          <a href={prefixLink('/api/mapbox-java/libandroid-telemetry/2.1.0/index.html')} className={`transition bright-blue-color-on-hover txt-bold color-gray-dark pl6 bg-transparent txt-ms`}>mapbox-android-telemetry</a>
          <a href={prefixLink('/api/mapbox-java/libandroid-ui/2.1.0/index.html')} className={`transition bright-blue-color-on-hover txt-bold color-gray-dark pl6 bg-transparent txt-ms`}>mapbox-android-ui</a>
      </div>
      }
